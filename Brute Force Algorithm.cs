...
namespace BruteForce
{
    internal class Program
    {
        ...
        public static bool BruteForce(string testChars, int startLength, 
            int endLength, BruteForceTest testCallback)
        {
        ...
        static void Main()
        {
            Console.Title = ("Brute Force Algorithm");
...
is a very general problem-solving technique and algorithmic paradigm 
that consists of systematically enumerating all possible candidates 
for the solution and checking whether each candidate
